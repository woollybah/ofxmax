...
Import "../ofxxmlsettings.mod/src/*.h"
Import "../ofxxmlsettings.mod/libs/*.h"
Import "../ofxmsainteractiveobject.mod/src/*.h"

Import "src/*.h"
Import "src/Controls/*.h"

Import "src/ofxSimpleGuiConfig.cpp"
Import "src/ofxSimpleGuiControl.cpp"
Import "src/ofxSimpleGuiPage.cpp"
Import "src/ofxSimpleGuiToo.cpp"
